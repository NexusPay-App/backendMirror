 ...
 */
export async function getConversionRateWithCaching(): Promise<number> {
    try {
 ...
 */
async function fetchUSDCToKESPrice(): Promise<number> {
    try {
 ...
 */
export async function forceRefreshConversionRate(): Promise<number> {
    try {
        // Fetch new rate
